...
上位机上传实时数据
********************************************************************************************************************/
void senddata(unsigned int ntu,unsigned int ph,unsigned int tds,unsigned int tdsvalue,unsigned int ywd, int hwd,  int *ntu_max, int *ph_max, int *ph_min, int *tds_max, int *tdsvalue_max)  //要用发送    ntu, tdsvalue, ph, tds;
{
